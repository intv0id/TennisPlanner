...
public class SearchResultItem
{
    ...
    public readonly Dictionary<GeoCoordinates, Task<JourneyDurationDto?>> journeyDurationsTasks;
        ...
        string courtRoof)
    {
        ...
        journeyDurationsTasks = new Dictionary<GeoCoordinates, Task<JourneyDurationDto>>();
    }
}
